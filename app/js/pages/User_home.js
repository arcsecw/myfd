...
var User_home = React.createClass({
    render() {
        return (
            <PageContainer>
                ...
                <link href="i/css/user_home/styles.css" type="text/css" rel="stylesheet"/>
                <div id="base" className="">
                    ...
                    <div id="u14" className="ax_paragraph">
                        ...
                        <div id="u15" className="text">
                            <p><span className="u77">全部订单</span></p>
                        </div>
                    </div>
                    ...
                    <div id="u18" className="ax_paragraph">
                        <img id="u18_img" className="img " src="i/resources/images/transparent.gif"/>
                    ...
                    <div id="u20" className="ax_shape">
                        <img id="u20_img" className="img " src="i/images/user_home/u20.png"/>

                        <div id="u21" className="text">
                            <p><span>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span><span>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span><span> 订单详情&nbsp; </span><span>&nbsp; </span><span>&nbsp; &nbsp; </span><span>&nbsp; &nbsp; &nbsp; &nbsp; </span><span>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span><span>&nbsp; </span><span>&nbsp; &nbsp; </span><span> 患者&nbsp; &nbsp; &nbsp; &nbsp; </span><span>&nbsp; </span><span>&nbsp; </span><span>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span><span> 金额&nbsp; &nbsp; &nbsp; &nbsp; </span><span>&nbsp; &nbsp; </span><span>&nbsp; </span><span>&nbsp; </span><span> 状态&nbsp; </span><span>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span><span>操作</span></p>
                        </div>
                    </div>

                    <div id="u22" className="ax_table">


                        <div id="u23" className="ax_table_cell">
                            <img id="u23_img" className="img " src="i/images/user_home/u23.png"/>

                            <div id="u24" className="text">
                                <p><span>2016.3.20</span></p>
                            </div>
                        </div>


                        <div id="u25" className="ax_table_cell">
                            <img id="u25_img" className="img " src="i/images/user_home/u25.png"/>

                            <div id="u26" className="text">
                                <p><span>北京地区XXXX团队髌骨手术</span></p>
                            </div>
                        </div>


                        <div id="u27" className="ax_table_cell">
                            <img id="u27_img" className="img " src="i/images/user_home/u27.png"/>
                        ...
                        <div id="u29" className="ax_table_cell">
                            <img id="u29_img" className="img " src="i/images/user_home/u29.png"/>
                        ...
                        <div id="u31" className="ax_table_cell">
                            <img id="u31_img" className="img " src="i/images/user_home/u31.png"/>
                        ...
                        <div id="u33" className="ax_table_cell">
                            <img id="u33_img" className="img " src="i/images/user_home/u33.png"/>

                            <div id="u34" className="text">
                                <p><span className="u77">催单</span></p>
                            </div>
                        </div>


                        <div id="u35" className="ax_table_cell">
                            <img id="u35_img" className="img " src="i/images/user_home/u35.png"/>
                        ...
                        <div id="u37" className="ax_table_cell">
                            <img id="u37_img" className="img " src="i/images/user_home/u37.png"/>
                        ...
                        <div id="u39" className="ax_table_cell">
                            <img id="u39_img" className="img " src="i/images/user_home/u39.png"/>
                        ...
                        <div id="u41" className="ax_table_cell">
                            <img id="u41_img" className="img " src="i/images/user_home/u41.png"/>
                        ...
                        <div id="u43" className="ax_table_cell">
                            <img id="u43_img" className="img " src="i/images/user_home/u43.png"/>
                        ...
                        <div id="u45" className="ax_table_cell">
                            <img id="u45_img" className="img " src="i/images/user_home/u45.png"/>
                        ...
                        <div id="u47" className="ax_table_cell">
                            <img id="u47_img" className="img " src="i/images/user_home/u47.png"/>
                        ...
                        <div id="u49" className="ax_table_cell">
                            <img id="u49_img" className="img " src="i/images/user_home/u49.png"/>
                        ...
                        <div id="u51" className="ax_table_cell">
                            <img id="u51_img" className="img " src="i/images/user_home/u51.png"/>
                        ...
                        <div id="u53" className="ax_table_cell">
                            <img id="u53_img" className="img " src="i/images/user_home/u53.png"/>
                        ...
                        <div id="u55" className="ax_table_cell">
                            <img id="u55_img" className="img " src="i/images/user_home/u55.png"/>
                        ...
                        <div id="u57" className="ax_table_cell">
                            <img id="u57_img" className="img " src="i/images/user_home/u57.png"/>
                    ...
                    <div id="u59" className="ax_droplist">
                        <select id="u59_input">
                            ...
                            <option value="2015年的订单">2015年的订单</option>
                            <option value="2014年的订单">2014年的订单</option>
                        </select>
                    </div>
