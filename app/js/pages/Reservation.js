            ...
            <PageContainer>
                <div id="base" className="">
                    ...
                    <div id="u4" className="ax_shape">
                        <img id="u4_img" className="img " src="i/imagesuser_reservation_operation_fill_page/u4.png"/>
                    ...
                    <div id="u12" className="ax_image">
                        <img id="u12_img" className="img " src="i/images/user_reservation_operation_fill_page/u21.png"/>
                    ...
                    <div id="u24" className="ax_shape">
                        ...
                        <div id="u25" className="text">
                            <p><span style={{color:'#333333'}}> 提交手术预约单意味着您仔细阅读并同意以下预约服务协议 </span><span >XXX服务协议链接XXXX</span></p>
                        </div>
                    </div>
                    ...
                    <div id="u35" className="ax_paragraph">
                        ...
                        <div id="u36" className="text">
                            <p><span >您好： </span><span >XXXX</span><span style={{color:'#333333'}}>&nbsp; &nbsp; </span><span style={{color:'#333333'}}>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span></p>
                        </div>
                    </div>
                        ...
                        <div id="u37_state0" className="panel_state" data-label="State1">
                            <div id="u37_state0_content" className="panel_state_content">
                                ...
                                <div id="u38" className="ax_menu">
                                    <img id="u38_menu" className="img " src="i/images/user_reservation_operation_fill_page/u32_menu.png" alt="u38_menu"/>
                                ...
                                <div id="u44" className="ax_horizontal_line">
                                    ...
                                    <img id="u44_line" className="img " src="i/images/user_reservation_operation_fill_page/u38_line.png" alt="u44_line"/>
                                </div>
                            </div>
                        </div>
                    </div>
